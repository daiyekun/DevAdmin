...
namespace WooDev.Model.Models
{
    ...
    /// 计划资金历史
    /// </summary>
    [SugarTable("dev_cont_plan_finance_hist")]
    public partial class DEV_CONT_PLAN_FINANCE_HIST:IDevEntitiy
    {
        /// <summary>
        /// DEV_CONT_PLAN_FINANCE_HIST构造函数
        /// </summary>
        public DEV_CONT_PLAN_FINANCE_HIST()
        {
