...
namespace WooDev.Model.Models
{
    ...
    /// 流程实例节点信息历史表
    /// </summary>
    [SugarTable("dev_flow_inst_node_info_hist")]
    public partial class DEV_FLOW_INST_NODE_INFO_HIST:IDevEntitiy
    {
        /// <summary>
        /// DEV_FLOW_INST_NODE_INFO_HIST构造函数
        /// </summary>
        public DEV_FLOW_INST_NODE_INFO_HIST()
        {
        ...
        /// 是否空值:False
        /// </summary>
        public int INST_HIST_ID { get; set; }
