...
namespace WooDev.Model.Models
{
    ...
    /// 合同文本
    /// </summary>
    [SugarTable("dev_cont_conttext")]
    public partial class DEV_CONT_CONTTEXT:IDevEntitiy
    {
        /// <summary>
        /// DEV_CONT_CONTTEXT构造函数
        /// </summary>
        public DEV_CONT_CONTTEXT()
        {
        ...
        /// 是否空值:True
        /// </summary>
        public string CONT_HIST_ID { get; set; }
