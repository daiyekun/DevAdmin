...
namespace WooDev.Model.Models
{
    ...
    /// 合同标的历史
    /// </summary>
    [SugarTable("dev_cont_sub_matter_hist")]
    public partial class DEV_CONT_SUB_MATTER_HIST:IDevEntitiy
    {
        /// <summary>
        /// DEV_CONT_SUB_MATTER_HIST构造函数
        /// </summary>
        public DEV_CONT_SUB_MATTER_HIST()
        {
