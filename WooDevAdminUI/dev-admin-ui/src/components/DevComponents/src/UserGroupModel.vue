...
<script lang="ts">
  ...
  import { getFlowGroupList } from '/@/api/devsys/flow/flowgroup';
  import { h } from 'vue';
  ...
  export default defineComponent({
    ...
    emits: ['rowGroupDbclick', 'selectRowGroup'],
    setup(_, { emit }) {
